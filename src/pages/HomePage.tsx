      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 py-32 text-center">
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold leading-tight animate-fade-in whitespace-nowrap" style={{ animationDelay: "0.1s" }}>
              <span className="text-accent">Jugnu Enterprises</span>
            </h1>
